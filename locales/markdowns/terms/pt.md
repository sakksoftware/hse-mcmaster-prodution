...
##19. Privacidade
O McMaster não coleta informações que identifiquem pessoalmente os indivíduos, exceto quando os indivíduos fornecer informações específicas de forma voluntária. Pode haver ocasiões em que informações pessoais específicas sejam solicitadas antes de um indivíduo poder entrar em certas seções do Site. Esta informação é armazenada em um servidor, acessível apenas por consultores Web autorizados que têm informações de autenticação. Em todos esses casos, o McMaster irá recolher apenas a informação que é fornecida voluntariamente pelo utilizador e compromete-se a manter tais informações estritamente confidenciais. Informações individuais fornecidas para o McMaster para ter acesso ao Site não serão vendidas nem disponibilizadas a terceiros.
